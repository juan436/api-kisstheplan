...
export class WebPageService {
  ...
  async getPublicPage(slug: string) {
    ...
    return {
      ...
      page: {
        ...
        allergyOptions: webPage.allergyOptions || [],
  ...
  async findGuestByToken(token: string) {
    ...
    return {
      ...
      wedding: {
        ...
        date: wedding.date,
        venue: wedding.venue,
        mealOptions: webPage?.mealOptions?.length ? webPage.mealOptions : (wedding.mealOptions ?? []),
        allergyOptions: webPage?.allergyOptions?.length ? webPage.allergyOptions : (wedding.allergyOptions ?? []),
        transportOptions: webPage?.transportOptions?.length ? webPage.transportOptions : (wedding.transportOptions ?? []),
        confirmMessage: webPage?.confirmMessage ?? '',
        rejectMessage: webPage?.rejectMessage ?? '',
      },
  ...
  toResponse(page: WebPage) {
    return {
      ...
      allergyOptions: page.allergyOptions || [],
